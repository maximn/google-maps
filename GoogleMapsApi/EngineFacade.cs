...
namespace GoogleMapsApi
{
        ...
        where TResponse : IResponseFor<TRequest>
    {
        ...
        public async Task<TResponse> Query(TRequest request, TimeSpan timeout)
        {
            return await MapsAPIGenericEngine<TRequest, TResponse>.QueryGoogleAPI(request, timeout);
        }
        ...
        {
            return await MapsAPIGenericEngine<TRequest, TResponse>.QueryGoogleAPI(request, TimeSpan.FromMilliseconds(Timeout.Infinite));
        }
    }
}