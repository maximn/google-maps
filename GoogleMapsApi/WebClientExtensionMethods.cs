...
namespace GoogleMapsApi
{
    ...
    public static class WebClientExtensionMethods
    {
        ...
        public static readonly string DefaultReferrer = string.Empty;
        ...
        {
            return client.DownloadDataTaskAsync(address, InfiniteTimeout, DefaultReferrer, token);
        }
        ...
        {
            return client.DownloadDataTaskAsync(address, timeout, DefaultReferrer, CancellationToken.None);
        }
        ...
        /// <exception cref="ArgumentNullException">Thrown when a null value is passed to the client or address parameters.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when the value of timeout is neither a positive value or infinite.</exception>
        public static Task<byte[]> DownloadDataTaskAsync(this WebClient client, Uri address, string referrer)
        {
            return client.DownloadDataTaskAsync(address, InfiniteTimeout, referrer, CancellationToken.None);
        }
        ...
        /// <exception cref="ArgumentNullException">Thrown when a null value is passed to the client or address parameters.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when the value of timeout is neither a positive value or infinite.</exception>
        public static Task<byte[]> DownloadDataTaskAsync(this WebClient client, Uri address, TimeSpan timeout, string referrer)
        {
            return client.DownloadDataTaskAsync(address, timeout, referrer, CancellationToken.None);
        }
        ...
        /// The specify an infinite timeout, pass a TimeSpan with a TotalMillisecond value of Timeout.Infinite.
        /// When a request is aborted due to a timeout the returned task will transition to the Faulted state with a TimeoutException.</param>
        /// <param name="referrer">The referrer to be sent with the request for referrer authorization.</param>
        /// <param name="token">A cancellation token that can be used to cancel the pending asynchronous task.</param>
        /// <returns>A Task with the future value of the downloaded string.</returns>
        /// <exception cref="ArgumentNullException">Thrown when a null value is passed to the client or address parameters.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when the value of timeout is neither a positive value or infinite.</exception>
        public static Task<byte[]> DownloadDataTaskAsync(this WebClient client, Uri address, TimeSpan timeout, string referrer, CancellationToken token)
        {
