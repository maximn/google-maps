...
namespace GoogleMapsApi.Test.IntegrationTests
{
    ...
    class PlaceAutocompleteTests : BaseTestIntegration
    {
        ...
        public void ReturnsNoResults()
        {
            ...
            PlaceAutocompleteResponse result = GoogleMaps.PlaceAutocomplete.Query(request).Result;
        ...
        public void OffsetTest()
        {
            ...
            PlaceAutocompleteResponse offsetResult = GoogleMaps.PlaceAutocomplete.Query(offsetRequest).Result;
